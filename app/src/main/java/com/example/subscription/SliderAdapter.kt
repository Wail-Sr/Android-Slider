...
class SliderAdapter(imageUrl: ArrayList<String>, textTitle: ArrayList<String>, sliderDesc: ArrayList<String>):
    SliderViewAdapter<SliderAdapter.SliderViewHolder>() {

    // on below line we are creating a
    // new array list and initializing it.
    var sliderList: ArrayList<String> = imageUrl
    var sliderTitels: ArrayList<String> = textTitle
    var sliderDescs: ArrayList<String> = sliderDesc
    ...
    override fun onBindViewHolder(viewHolder: SliderAdapter.SliderViewHolder?, position: Int) {
        ...
        if (viewHolder != null) {
            ...
            // on below line we are setting text to our title view.
            viewHolder.titleView.text = sliderTitels[position]

            // on below line we are setting text to our text view.
            viewHolder.descView.text = sliderDescs[position]
    ...
    class SliderViewHolder(itemView: View?) : SliderViewAdapter.ViewHolder(itemView) {
        ...
        var titleView: TextView = itemView!!.findViewById(R.id.slideTitle)
        var descView: TextView = itemView!!.findViewById(R.id.textView2)
    }
}